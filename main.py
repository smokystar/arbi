...
# con.commit()
# cur.execute(f'insert into arbi_users(tele_id) values (916201061)')
# con.commit()
# cur.execute(f'insert into arbi_users(tele_id) values (946148849)')
# con.commit()
# cur.execute(f'insert into arbi_users(tele_id) values (746251279)')
# con.commit()
